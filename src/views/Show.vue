    ...
    <div class="info-overlay" :class="{ 'open': isInfoOpen }">
      <div class="info-content">
        ...
        <div class="info-header">
          <h2 class="info-title"> 桥况智析 桥梁病害诊断系统</h2>
...
<div class="info-body">
          <section class="info-section">
            ...
            <div class="section-content">
              <div class="info-text">
                <p class="info-text-highlight"> 桥况智析 桥梁智能巡检与全息诊断决策基座，是依托先进计算机视觉与多模态大语言模型打造的划时代桥梁基础设施病害检测平台。</p>
                ...
                <p>这不仅是一套病害识别工具，更是面向未来交通枢纽的“预防性养护”数字大脑。 桥况智析 致力于打破数据孤岛，赋能交通管理部门实现从“被动抢修”向“主动干预”的战略跨越，实现运维成本的指数级降低与桥梁服役寿命的极限延伸。</p>
              </div>
              <div class="info-image-placeholder large">
                <img src="/zhixi.png" alt=" 桥况智析" class="feature-img">
              </div>
            </div>
          </section>
                ...
                <div class="scenario-item scenario-item-1">
                  <div class="scenario-content">
                    ...
                    <div class="scenario-text">
                      <h4>桥梁例行巡检与数字建档</h4>
                      <p>深度赋能路政及桥梁养护单位的日常巡检业务。依托高并发计算集群， 桥况智析 能够极速吞吐无人机及车载抓拍的海量表观图像，将非结构化的杂乱数据瞬间转化为标准化的病害台账。大幅降低人工登高、下水作业的安全风险与主观漏检率，为每一座桥梁建立伴随其全生命周期的超清数字健康档案。</p>
                    </div>
                  </div>
                </div>
...
.info-body::-webkit-scrollbar-thumb:hover {
  ...
  .scenario-item-2:hover {
    transform: perspective(1000px) rotateY(-4deg) translateY(-5px);
  }
  .scenario-item-4:hover {
    transform: perspective(1000px) rotateY(-4deg) translateY(-5px);
  }
